...
const homePageSections=[
  ...
  const genreList={
    ...
    function({genres}){
        ...
        fetchDataFromServer(`https://api.themoviedb.org/3/movie/popular?lapi_key=${api_key}&page=1`,heroBanner);
...
<div class="control-inner"></div>
    ...
    for(const[index,movie]of movieList.entries()){
        ...
        <img src="${imageBaseURL}w1280${backdrop_path}" alt="${title}" class="img-cover" loading=${index ===0?
        "eager" :"lazy"}>
